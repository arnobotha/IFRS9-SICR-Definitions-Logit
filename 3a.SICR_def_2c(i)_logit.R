...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=3, d=2, and s=3", x= "Time") + 
...
# Term, FurtherLoan_Ind, FurtherLoan_Amt and BalanceToTerm
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Receipt_Inf + Balance + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE + AgeToTerm
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 71.10%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 70.79%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_2) # 73.83%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_2) # 73.34%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 98.65%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 98.60%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 98.65%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 98.60%

summary(logit_model_delinq1)
summary(logit_model_delinq2)
# Keep the imputed variables since there is no difference in the AUC-values and the same number of variables are insignificant for both
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 78.24% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 77.56%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 78.24% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 77.56%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 58.88% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 60.80%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.74% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 60.70%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 60.01% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 62.82%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 60.09% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 63.37%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 60.93% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 63.50%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 60.69% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 63.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 59.42% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 61.66%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 59.60% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 62.36%

# There is no reduction in AUC
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 60.44% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 63.03%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 59.59% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 62.69%

# The 0-month lag is the most significant - keep
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 61.14% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 63.16%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 60.19% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 63.21%

# The 0 and 12-month lags are insignificant
# The reduction in AUC is more significant than the previous variables, but the standard errors are big for the volatility variables
...
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealIncome_Growth + 
                                     M_RealIncome_Growth_12 + M_RealGDP_Growth


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
inputs_chosen <- SICR_target_event ~ Age_Adj + Term + Receipt_InfLog + BalanceLog + AgeToTerm + g0_Delinq + PrevDefaults + slc_acct_roll_ever_24_imputed + slc_pmnt_method + 
                                     slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + 
                                     M_Emp_Growth_12 + M_RealIncome_Growth 
                                     # LN_TPE + BalanceToTerm + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + slc_acct_arr_dir_3 + M_RealIncome_Growth_12 + 
                                     # M_RealGDP_Growth
...
# Age_Adj, Term, Receipt_InfLog, BalanceLog, AgeToTerm, g0_Delinq, PrevDefaults, slc_acct_roll_ever_24_imputed, slc_pmnt_method, slc_acct_pre_lim_perc_imputed
# Will only test the MVs on the second iteration
# Iteration 2
# The significance of the MVs are:
# The 12-month real income growth and the real GDP growth are insignificant - remove

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2c_i := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2c_i := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2c_i) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2c_i) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 98.183% | Iteration 2's AUC: 98.19%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + TimeInPerfSpell + g0_Delinq + 
                                      PrevDefaults + slc_acct_roll_ever_24_imputed + slc_acct_pre_lim_perc_imputed + 
                                      M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealIncome_Growth + 
                                      M_RealIncome_Growth_12
...
datSICR_valid[, Prob_chosen_2c_i := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
...
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2c_i) # 76.28%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 81.91%
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_2c_i)) + theme_bw() + 
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2c_i", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
datSICR_train[, Pred_chosen_2c_i := ifelse(Prob_chosen_2c_i >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_2c_i := ifelse(Prob_chosen_2c_i >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2c_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2c_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_2c_i), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_2c_i == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_2c_i == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_2c_i == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_2c_i == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.02508713

# A few things of concern:
# 1) Volatility in event rates due to relatively low sampling volumes in validation set
# 2) 0-counts over 20006-2007 periods using discretised output [Pred_chosen_2c_i]
...
performance_measures_2c_i <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                        d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_2c_i); gc()
