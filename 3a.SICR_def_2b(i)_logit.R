...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2b_i", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.07685233
