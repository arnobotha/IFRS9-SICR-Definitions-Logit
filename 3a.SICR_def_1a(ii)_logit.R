...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_ii) # 88.24%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1a_ii) # 88.48%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 88.31%
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_1a_ii", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.10885053
