...
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 80.96%
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2c_iii", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.09215899
