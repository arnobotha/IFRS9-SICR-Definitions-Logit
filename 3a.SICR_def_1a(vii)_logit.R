...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_vii) # 78.41%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1a_vii) # 79.02%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 78.60%
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_1a_vii", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.09371101
