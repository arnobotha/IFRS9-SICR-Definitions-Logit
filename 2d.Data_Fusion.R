...
sum(datCredit_real$slc_acct_pre_lim_perc_imputed == "" | is.na(datCredit_real$slc_acct_pre_lim_perc_imputed))==0 # check - success
...
sum(datCredit_real$slc_acct_roll_ever_24_imputed == "" | is.na(datCredit_real$slc_acct_roll_ever_24_imputed))==0 # check - success
...
sum(datCredit_real$slc_acct_prepaid_perc_dir_12_imputed == "" | is.na(datCredit_real$slc_acct_prepaid_perc_dir_12_imputed))==0 # check - success
