# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2b(i) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=3, d=2, and s=2", x= "Time") + 
...
# Age_Adj, FurtherLoan_Ind, FurtherLoan_Amt, AgeToTerm, BalanceToTerm
...
inputs_account3 <- SICR_target_event ~ Term + Receipt_Inf + Balance + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 70.86%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 70.33%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 72.51%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 72.96%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 96.32%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 96.72%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 96.32%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 96.72%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 75.61% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 76.94%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 75.61% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 76.94%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 58.44% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 57.93%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.44% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 57.92%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 59.77% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 59.62%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 59.74% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 59.50%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 60.65% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.81%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 60.56% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 60.73%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 59.01% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 59.05%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 59.21% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 59.00%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 60.34% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 60.45%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 59.58% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 59.46%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 60.49% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 60.60%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 59.74% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 59.45%
...
inputs_chosen <- SICR_target_event ~ Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + TimeInPerfSpell + g0_Delinq + 
                                     PrevDefaults + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + 
                                     M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealIncome_Growth + 
                                     M_RealIncome_Growth_12
                                     # LN_TPE + PerfSpell_Num
...
# Receipt_InfLog, BalanceLog, BalanceToTerm, InterestRate_Margin, TimeInPerfSpell, g0_Delinq, PrevDefaults, slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed
# slc_pmnt_method, slc_acct_pre_lim_perc_imputed, M_Repo_Rate
# Iteration 2
# The significance of the MVs are:
# Repo rate, 12-month employment growth lag is somewhat significant (p-value of 16.79%), DTI growth rate is somewhat significant (p-value of 18.04%)
# Inflation growth rate is the least significant
# TimeInPerfSpell does not meet the 5% threshold, but still has a p-value of 12.51%, which can be deemed as significant

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2b_i := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2b_i := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2b_i) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2b_i) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 96.93% | Iteration 2's AUC: 96.92%
...
# Not all variables are statistically significant, including: Balance to term, receipts, the missing and statement group of payment method group,
# the prepaid funds, time in performing spell, the missing and rolling groups of account direction, the repo rate,
# inflation growth rate, 12-month DTI growth, and employment growth
# After including PD ratio, the statistically insignificant variables are: Balance to term, receipts, the missing and statement group of payment method group,
# the prepaid funds, time in performing spell, the missing and rolling groups of account direction, the repo rate,
# inflation growth rate, 12-month DTI growth, and employment growth
# Therefore, the inclusion of PD ratio did not change the significance of any variables
# [Ad hoc] PD ratio is not statistically significant (p-value of 0.92191 and standard error of 0.00121717)
...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2b_i) # 97.20% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2b_i) # 97.15% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 97.18% (before and after)
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2b_i, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2b_i, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_2b_i); gc()
