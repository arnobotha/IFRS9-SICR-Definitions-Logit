# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2a(ii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=6, d=2, and s=1", x= "Time") + 
...
# Balance, FurtherLoan_Ind, FurtherLoan_Amt, AgeToTerm and BalanceToTerm
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.05%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 58.77%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 64.05%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 63.57%
...
# TimeInPerfSpell is insignificant, but keep to analyse with the other variables
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 84.10%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 84.78%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 84.10%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 84.77%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 73.68% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 74.03%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 73.68% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 74.03%
...
# M_Repo_Rate is the most significant at 8.25%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 57.34% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 57.22%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 57.02% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 56.87%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 58.24% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 58.18%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 58.13% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 58.06%
...
# M_DTI_Growth_12 is the most significant at 15.70%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 59.46% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 59.51%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 59.47% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 59.51%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 58.44% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 58.42%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 57.50% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 57.41%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 59.36% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 59.40%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 58.48% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 58.43%
...
# M_RealIncome_Growth_12 is somewhat significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 59.22% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 59.24%
...
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 57.78%

# The reduction in AUC is more significant than the previous variables, but the standard errors are big for the volatility variables

# Model with all the significant MVs
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + 
                                     M_RealGDP_Growth + M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
inputs_chosen <- SICR_target_event ~ Receipt_InfLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + 
                                     PrevDefaults + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + 
                                     slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12
                                     # Age_Adj + BalanceLog + LN_TPE + M_Emp_Growth + M_Emp_Growth_12 + M_RealIncome_Growth +
...
# M_Emp_Growth, M_Emp_Growth_12, M_RealIncome_Growth and M_RealIncome_Growth_12
# Iteration 3
# M_RealGDP_Growth and M_RealGDP_Growth_12
# Iteration 4
# PrevDefaults has a p-value of 7.19% and repo rate is insignificant (p-value of 26.64%)

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2a_ii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2a_ii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2a_ii) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2a_ii) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 88.31% | Iteration 2's AUC: 88.32% | Iteration 3's AUC: 88.33% | Iteration 4's AUC: 88.33%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Receipt_InfLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + 
                                      PrevDefaults + slc_acct_roll_ever_24_imputed + 
                                      slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12
...
# InterestRate_Margin, BalanceLog, slc_pmnt_method, slc_acct_pre_lim_perc_imputed, TimeInPerfSpell, PerfSpell_Num, g0_Delinq, slc_acct_arr_dir_3,
# slc_acct_roll_ever_24_imputed, M_Repo_Rate, M_Inflation_Growth, M_DTI_Growth, M_DTI_Growth_12
# Possibly term, M_RealIncome_Growth, M_RealIncome_Growth_12, M_RealGDP_Growth and M_RealGDP_Growth_12

# Investigate whether to include term
# Investigate whether to use the real GDP or real income variables

# Now, the input space should be finalized across definitions 2a(i)-(iv)
...
# All the set variables with and without term
# Without term
inputs_check1 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
...
logit_model_check1 <- glm(inputs_check1, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check1)
dat_SICR_def_valid_s[, Prob_check1 := predict(logit_model_check1, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check1) # 88.15%

# With term
inputs_check2 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                                     PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                                     M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + Term
logit_model_check2 <- glm(inputs_check2, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check2)
dat_SICR_def_valid_s[, Prob_check2 := predict(logit_model_check2, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check2) # 88.15
# Term is not significant - remove

# Include real income growth
inputs_check3 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                                     PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                                     M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealIncome_Growth
logit_model_check3 <- glm(inputs_check3, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check3)
# Real income growth is not significant
dat_SICR_def_valid_s[, Prob_check3 := predict(logit_model_check3, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check3) # 88.14%

# Include 12-month real income growth lag
inputs_check4 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                                     PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                                     M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12
logit_model_check4 <- glm(inputs_check4, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check4)
# Real income growth or its 12-month lag is not significant
dat_SICR_def_valid_s[, Prob_check4 := predict(logit_model_check4, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check4) # 88.14%

# Include real GDP growth
inputs_check5 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                                     PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                                     M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealGDP_Growth
logit_model_check5 <- glm(inputs_check5, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check5)
# Real GDP growth is not significant
dat_SICR_def_valid_s[, Prob_check5 := predict(logit_model_check5, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check5) # 88.14%

# Include 12-month real GDP growth lag
inputs_check6 <- SICR_target_event ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                                     PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                                     M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_12
logit_model_check6 <- glm(inputs_check6, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_check6)
# Real GDP growth or its 12-month lag is not significant
dat_SICR_def_valid_s[, Prob_check6 := predict(logit_model_check6, newdata = dat_SICR_def_valid_s, type="response")]
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_check6) # 88.15
...
# All the set variables with and without term
# Without term
inputs_check1 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12
logit_model_check1 <- glm(inputs_check1, data=datSICR_train, family="binomial")
summary(logit_model_check1)
datSICR_valid[, Prob_check1 := predict(logit_model_check1, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check1) # 86.82%

# With term
inputs_check2 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + Term
logit_model_check2 <- glm(inputs_check2, data=datSICR_train, family="binomial")
summary(logit_model_check2)
datSICR_valid[, Prob_check2 := predict(logit_model_check2, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check2) # 86.82%
# Term is not significant - remove

# Include real income growth
inputs_check3 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealIncome_Growth
logit_model_check3 <- glm(inputs_check3, data=datSICR_train, family="binomial")
summary(logit_model_check3)
# Real income growth is not significant
datSICR_valid[, Prob_check3 := predict(logit_model_check3, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check3) # 86.73%

# Include 12-month real income growth lag
inputs_check4 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12
logit_model_check4 <- glm(inputs_check4, data=datSICR_train, family="binomial")
summary(logit_model_check4)
# Real income growth and its 12-month lag are not significant
datSICR_valid[, Prob_check4 := predict(logit_model_check4, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check4) # 86.74%

# Include real GDP growth
inputs_check5 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealGDP_Growth
logit_model_check5 <- glm(inputs_check5, data=datSICR_train, family="binomial")
summary(logit_model_check5)
# Real GDP growth is not significant
datSICR_valid[, Prob_check5 := predict(logit_model_check5, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check5) # 86.73%

# Include 12-month real GDP growth lag
inputs_check6 <- SICR_target ~ InterestRate_Margin + BalanceLog + slc_pmnt_method + slc_acct_pre_lim_perc_imputed + TimeInPerfSpell + 
                               PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + M_Repo_Rate +
                               M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_12
logit_model_check6 <- glm(inputs_check6, data=datSICR_train, family="binomial")
summary(logit_model_check6)
# Real GDP growth and its 12-month lag are not significant
datSICR_valid[, Prob_check6 := predict(logit_model_check6, newdata = datSICR_valid, type="response")]
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_check6) # 86.72%
...
summary(logit_model_chosen)
# Most variables are statistically significant, except: pmnt_method_grp (but only its "MISSING" bin), TimeInPerfSpell,
#   PerfSpell_Num, slc_acct_arr_dir_3 (but only its "MISSING" bin), M_Repo_Rate
...
datSICR_valid[, Prob_chosen_2a_ii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2a_ii) # 87.99% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2a_ii) # 86.82% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 87.59% (before and after)
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_2a_ii)) + theme_bw() + 
...
datSICR_train[, Pred_chosen_2a_ii := ifelse(Prob_chosen_2a_ii >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_2a_ii := ifelse(Prob_chosen_2a_ii >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2a_ii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2a_ii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_2a_ii), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_2a_ii == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_2a_ii == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_2a_ii == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_2a_ii == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.2531016

# A few things of concern:
# 1) Volatility in event rates due to relatively low sampling volumes in validation set
# 2) 0-counts over 20006-2007 periods using discretised output [Pred_chosen_2a_ii]
...
performance_measures_2a_ii <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                         d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_2a_ii); gc()
