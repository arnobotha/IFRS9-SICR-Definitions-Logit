...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1b_i) # 93.50% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1b_i) # 93.77% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 93.59% (before and after)
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1078413
