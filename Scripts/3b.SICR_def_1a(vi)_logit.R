...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$ExpProb) # 80.34% vs 80.35%
auc(datSICR_valid$SICR_target, datSICR_valid$ExpProb) # 80.63% vs 80.64%
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1129069
