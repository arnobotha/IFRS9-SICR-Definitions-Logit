# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 1a(ii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=6, d=1, and s=1", x= "Time") + 
...
# Balance, AgeToTerm and BalanceToTerm
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + FurtherLoan_Ind +
                                       FurtherLoan_Amt + LN_TPE
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_2) # 64.79%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_2) # 64.89%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.46%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 60.58%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 84.82%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 84.97%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 84.84%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 84.99%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 75.06% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 75.10%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 75.06% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 75.10%
...
# M_Repo_Rate, M_Repo_Rate_1, M_Repo_Rate_6, M_Repo_Rate_9, M_Repo_Rate_11, M_Repo_Rate_Vol_3, M_Repo_Rate_Vol_7, M_Repo_Rate_Vol_10 
# and M_Repo_Rate_Vol_12 are significant
...
# M_Repo_Rate, M_Repo_Rate_2, M_Repo_Rate_3 and M_Repo_Rate_10 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 59.14% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 59.12%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.51% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 58.49%
...
# M_Inflation_Growth, M_Inflation_Growth_1, M_Inflation_Growth_7, M_Inflation_Growth_10, M_Inflation_Growth_11, M_Inflation_Growth_12,
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 59.04% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 59.04%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 58.70% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 58.70%
...
# M_DTI_Growth_11, M_DTI_Growth_12, and M_DTI_Growth_Vol_7 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 60.59% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.59%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 60.35% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 60.35%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 59.37% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 59.38%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 58.05% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 58.05%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 60.22% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 60.23%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 59.60% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 59.61%
...
# M_RealIncome_Growth, M_RealIncome_Growth_12, M_RealIncome_Growth_Vol_2 and M_RealIncome_Growth_Vol_10 are significant
...
# M_RealIncome_Growth_9, M_RealIncome_Growth_11 and M_RealIncome_Growth_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 59.89% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 59.88%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 58.52% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 58.51%

# RESULT: Very small reduction, approximately 0.3%, in AUC

# Model with all the significant MVs
inputs_macro <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_3 + M_Repo_Rate_10 + M_Inflation_Growth +
                                    M_Inflation_Growth_1 + M_Inflation_Growth_10 + M_DTI_Growth + M_DTI_Growth_11 + M_DTI_Growth_12 + 
                                    M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 + M_Emp_Growth_12 + M_RealGDP_Growth + 
                                    M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth_9 + M_RealIncome_Growth_11 + 
                                    M_RealIncome_Growth_12


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
# inputs_chosen <- SICR_target_event ~ Term + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + PrevDefaults +
                                     ...
                                     # M_Repo_Rate + M_Repo_Rate_3 + M_DTI_Growth + M_RealGDP_Growth + M_RealGDP_Growth_12
                                     # LN_TPE + AgeToTerm + M_Repo_Rate_2 + M_Repo_Rate_10 + M_Inflation_Growth + M_Inflation_Growth_1 + 
                                     # M_Inflation_Growth_10 + M_DTI_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + 
                                     # M_Emp_Growth_11 + M_Emp_Growth_12 + M_RealIncome_Growth_9 + M_RealIncome_Growth_11 + M_RealIncome_Growth_12 +
                                     # Age_Adj + M_RealGDP_Growth_11

# Final variable selection
# check the distribution of term
table(dat_SICR_def_train_s$Term) %>% prop.table()
# 240 months is 90.69% of the population - this is enough to keep the variable

# check the distribution of loan type
table(dat_SICR_def_train_s$LN_TPE) %>% prop.table()
# CHL is 96.28% of the population. This means that only 3.72% of the population is WHL loans. Rather discard the variable to remove potential
# complications with the intercept variable

# check the significance between the receipt variable and the balance
inputs_rec <- SICR_target_event ~ Receipt_InfLog
inputs_bal <- SICR_target_event ~ BalanceLog
inputs_rec_bal <- SICR_target_event ~ Receipt_InfLog + BalanceLog
logit_model_rec <- glm(inputs_rec, data=dat_SICR_def_train_s, family="binomial")
logit_model_bal <- glm(inputs_bal, data=dat_SICR_def_train_s, family="binomial")
logit_model_rec_bal <- glm(inputs_rec_bal, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_rec)
summary(logit_model_bal)
summary(logit_model_rec_bal)
# the receipt and balance variables are equally important based on p-values
# the standard error of the balance variable is larger
# check the significance in conjunction with the other account-level variables
inputs_rec <- SICR_target_event ~ Term + InterestRate_Margin + BalanceToTerm + Receipt_InfLog
inputs_bal <- SICR_target_event ~ Term + InterestRate_Margin + BalanceToTerm + BalanceLog
inputs_rec_bal <- SICR_target_event ~ Term + InterestRate_Margin + BalanceToTerm + Receipt_InfLog + BalanceLog
logit_model_rec <- glm(inputs_rec, data=dat_SICR_def_train_s, family="binomial")
logit_model_bal <- glm(inputs_bal, data=dat_SICR_def_train_s, family="binomial")
logit_model_rec_bal <- glm(inputs_rec_bal, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_rec)
summary(logit_model_bal)
summary(logit_model_rec_bal)
# again, both variables are equally important
# however, due to the possible corruption of the variable, discard it
# the final account-level variables are thus: Term, InterestRate_Margin, BalanceToTerm, BalanceLog

# the final delinquency variables are: TimeInPerfSpell, PerfSpell_Num, g0_Delinq, PrevDefaults, slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed

# try to condense some of the payment method groups
table(dat_SICR_def_train_s$slc_pmnt_method) %>% prop.table()
# investigate the default rate per payment method group
totalSICR = sum(dat_SICR_def_train_s$SICR_target_event == "1")
dat_SICR_def_train_s %>% 
  filter(SICR_target_event == "1") %>% #Only look at cancellations
  group_by(slc_pmnt_method) %>% #Group per reason
  summarise(n = n(), rate = n() / totalSICR) %>% #Calculate the sum and rate
  arrange(desc(rate))
# statement has the highest SICR-rate, followed by debit order FNB account, then the missing group, then the debit order by another bank,
# then salary and lastly suspense
# condense the debit order group
# suspense is very small - group with the salary variable
# investigate the drop in AUC
inputs_pmnt_grp1 <- SICR_target_event ~ slc_acct_pre_lim_perc_imputed + slc_pmnt_method
logit_pmnt_grp1 <- glm(inputs_pmnt_grp1, data=dat_SICR_def_train_s, family="binomial")
summary(logit_pmnt_grp1)
inputs_pmnt_grp2 <- SICR_target_event ~ slc_acct_pre_lim_perc_imputed + pmnt_method_grp
logit_pmnt_grp2 <- glm(inputs_pmnt_grp2, data=dat_SICR_def_train_s, family="binomial")
summary(logit_pmnt_grp2)

dat_SICR_def_train_s[, Prob_pmnt_grp1 := predict(logit_pmnt_grp1, newdata = dat_SICR_def_train_s, type="response")]
dat_SICR_def_valid_s[, Prob_pmnt_grp1 := predict(logit_pmnt_grp1, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_pmnt_grp1) # 75.06% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_pmnt_grp1) # 75.10%

dat_SICR_def_train_s[, Prob_pmnt_grp2 := predict(logit_pmnt_grp2, newdata = dat_SICR_def_train_s, type="response")]
dat_SICR_def_valid_s[, Prob_pmnt_grp2 := predict(logit_pmnt_grp2, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_pmnt_grp2) # 74.90% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_pmnt_grp2) # 74.95%

# RESULT: Very small drop in the AUC
# the final behavioural variables are thus: slc_acct_pre_lim_perc_imputed and pmnt_method_grp

# choose the final macroeconomic variables
# investigate the raw variables and a lag of 12 months
# first, check the repo and inflation
inputs_macro_all2 <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_12 + M_Inflation_Growth + M_Inflation_Growth_12
logit_macro_all2 <- glm(inputs_macro_all2, data=dat_SICR_def_train_s, family="binomial")
summary(logit_macro_all2)
# The significance of the variables are:
# 1) M_Repo_Rate, 2) M_Inflation_Growth_12, 3) M_Repo_Rate_12 and 4) M_Inflation_Growth - all are significant
# add DTI
inputs_macro_all3 <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_12 + M_Inflation_Growth + M_Inflation_Growth_12 + M_DTI_Growth + M_DTI_Growth_12
logit_macro_all3 <- glm(inputs_macro_all3, data=dat_SICR_def_train_s, family="binomial")
summary(logit_macro_all3)
# The significance of the variables are:
# 1) M_Repo_Rate, M_DTI_Growth, M_DTI_Growth_12 (same p-value), 2) M_Inflation_Growth_12, 3) M_Repo_Rate_12 (6.06%), 4) M_Inflation_Growth (16.07%)
# add employment
inputs_macro_all4 <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_12 + M_Inflation_Growth + M_Inflation_Growth_12 + M_DTI_Growth + M_DTI_Growth_12 +
                                         M_Emp_Growth + M_Emp_Growth_12
logit_macro_all4 <- glm(inputs_macro_all4, data=dat_SICR_def_train_s, family="binomial")
summary(logit_macro_all4)
# The significance of the variables are:
# 1) M_Repo_Rate, M_DTI_Growth, M_DTI_Growth_12 (same p-value), 2) M_Emp_Growth_12 (11.20%), 3) M_Repo_Rate_12 (11.70%), 
# 4) M_Emp_Growth (23.60%), 5) M_Inflation_Growth_12 (30.60%), and 6) M_Inflation_Growth (90.70%)
# add real GDP and real income
inputs_macro_all6 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_Inflation_Growth_12 + M_DTI_Growth + M_DTI_Growth_12 +
                                         M_Emp_Growth + M_Emp_Growth_12 + M_RealGDP_Growth + M_RealIncome_Growth 
                                         # M_RealGDP_Growth_12 + M_RealIncome_Growth_12 + M_Repo_Rate_12
logit_macro_all6 <- glm(inputs_macro_all6, data=dat_SICR_def_train_s, family="binomial")
summary(logit_macro_all6)
# The significance of the variables are:
# 1) M_Repo_Rate and M_DTI_Growth, 2) M_DTI_Growth_12, 3) M_RealIncome_Growth, 4) M_Emp_Growth, 5) M_Inflation_Growth, 6) M_RealGDP_Growth (9.00%),
# 7) M_Emp_Growth_12 (16.32%), 8) M_Repo_Rate_12 (21.37%), 9) M_Inflation_Growth_12 (25.35%), 10) M_RealIncome_Growth_12 (52.43%),
# 11) M_RealGDP_Growth_12 (94.92%)
# remove M_RealGDP_Growth_12 and M_RealIncome_Growth_12
# The only insignificant variables are:
# M_Repo_Rate_12 and M_Inflation_Growth_12 (both with a p-value within 20%)
# from the previous analysis, M_Inflation_Growth_12 is more significant, so remove M_Repo_Rate_12
# now all the macroeconomic variables are significant
# the final macroeconomic variables are thus: M_Repo_Rate, M_Inflation_Growth, M_Inflation_Growth_12, M_DTI_Growth, M_DTI_Growth_12,
# M_Emp_Growth, M_Emp_Growth_12, M_RealGDP_Growth, M_RealIncome_Growth

# fit the final model
# inputs_chosen <- SICR_target_event ~ Term + InterestRate_Margin + BalanceToTerm + BalanceLog + TimeInPerfSpell + PerfSpell_Num + g0_Delinq +
                                     # PrevDefaults + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_acct_pre_lim_perc_imputed +
                                     # pmnt_method_grp + M_Repo_Rate + M_Inflation_Growth + M_Inflation_Growth_12 + M_DTI_Growth + M_DTI_Growth_12 +
                                     # M_Emp_Growth + M_Emp_Growth_12 + M_RealGDP_Growth + M_RealIncome_Growth
...
# - Compute the AUC
# dat_SICR_def_train_s[, Prob_chosen_1a_ii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
# dat_SICR_def_valid_s[, Prob_chosen_1a_ii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

# auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1a_ii) 
# auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1a_ii)

# Report the final AUC: 88.43%

# Report the AUC for the validation dataset
# Iteration 1's AUC: 88.47% | Iteration 2's AUC: 88.46% | Iteration 3's AUC: 88.46% | Iteration 4's AUC: 88.45% 

# NOTE: With the volatility variables Report the AUC for the validation dataset
# Iteration 1's AUC: 88.46% | Iteration 2's AUC: 88.42% | Iteration 3's AUC: 88.42% | Iteration 4's AUC: 88.39% | Iteration 5's AUC: 88.38%

# - Analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Term + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + PrevDefaults +
                                      TimeInPerfSpell + PerfSpell_Num + g0_Delinq + slc_acct_roll_ever_24_imputed + slc_acct_pre_lim_perc_imputed +
                                      M_Repo_Rate + M_Repo_Rate_3 + M_DTI_Growth + M_RealGDP_Growth + M_RealGDP_Growth_12
                                      # Age_Adj + M_RealGDP_Growth_11
...
# Iteration 1: Age_Adj, M_RealGDP_Growth_11, M_RealGDP_Growth_12, M_Repo_Rate and M_Repo_Rate_3 has VIF > 10
# Remove Age_Adj and M_RealGDP_Growth_11 (larger p-value than M_RealGDP_Growth_12)
#  M_Repo_Rate and M_Repo_Rate_3 has VIF > 10 but this is expected because of the lagged version
...
table(datSICR$SICR_target) %>% prop.table() # 93.86% Non-SICR vs 6.15% SICR
...
# All variables are statistically significant apart from the term variable
# PD ratio is not statistically significant (p-value of 0.905986 and standard error of 0.000016667) as well as term
# But all other variables remain statistically significant

# - Score data using fitted model
datSICR_train[, Prob_chosen_1a_ii := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_1a_ii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_ii) # 88.24% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1a_ii) # 88.48% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 88.31% (before and after)
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_1a_ii)) + theme_bw() + 
...
# The misclassification cost of 8 resulted in overprediction
# Investigate a misclassification cost of 7 and 6
# The cut-off value for a misclassification cost of 7 and 6 is exactly the same
# I ensured that this is true by re-running the optimal cut-off two times, as well as starting a new session and running it again
# After investigation, a final misclassification cost of 6 was chosen across all definitions
cost_fp <- 1; cost_fn <- 6
...
datSICR_train[, Pred_chosen_1a_ii := ifelse(Prob_chosen_1a_ii >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_1a_ii := ifelse(Prob_chosen_1a_ii >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1a_ii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1a_ii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_1a_ii == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_1a_ii == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_1a_ii == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_1a_ii == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1088475
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_1a_ii); gc()
