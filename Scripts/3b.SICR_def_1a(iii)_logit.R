# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 1a(iii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=9, d=1, and s=1", x= "Time") + 
...
# Balance, Redraw_Ind (so we need to remove Redraw_Amt as well) FurtherLoan_Ind, FurtherLoan_Amt, AgeToTerm and BalanceToTerm
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + InterestRate_Margin + LN_TPE
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_2) # 63.79%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_2) # 64.04%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 59.64%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 60.16%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 82.97%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 82.91%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 82.96%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 82.90%

# - Slightly higher AUC and lower -values on the training dataset using the imputed variables - keep.
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 74.47% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 74.46%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 74.47% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 74.46%
...
# M_Repo_Rate, M_Repo_Rate_2, M_Repo_Rate_4, M_Repo_Rate_6, M_Repo_Rate_9, M_Repo_Rate_10, M_Repo_Rate_11, 
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 58.92% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 58.91%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 57.84% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 57.82%
...
# M_Inflation_Growth, M_Inflation_Growth_1, M_Inflation_Growth_10 and M_Inflation_Growth_11 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 58.31% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 58.31%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 57.83% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 57.83%
...
# M_DTI_Growth, M_DTI_Growth_11, M_DTI_Growth_12, M_DTI_Growth_Vol_7 and M_DTI_Growth_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 60.30% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 59.99% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 59.99%
...
# M_RealGDP_Growth, M_RealGDP_Growth_1, M_RealGDP_Growth_4 and M_RealGDP_Growth_12 are significant
...
# M_RealIncome_Growth, M_RealIncome_Growth_8, M_RealIncome_Growth_9, M_RealIncome_Growth_11 and M_RealIncome_Growth_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 59.42% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 59.41%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 58.56% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 58.56%

# Not even a 1% reduction

# Model with all the significant MVs
inputs_macro <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_3 + M_Repo_Rate_4 + M_Repo_Rate_6 + M_Repo_Rate_8 + M_Repo_Rate_10 +
                                    M_Inflation_Growth + M_Inflation_Growth_1 + M_Inflation_Growth_10 + M_Inflation_Growth_11 + 
                                    M_DTI_Growth + M_DTI_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + 
                                    M_Emp_Growth_11 + M_Emp_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealGDP_Growth_4 + 
                                    M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_8 +
...
# inputs_chosen <- SICR_target_event ~ Term + Receipt_InfLog + BalanceLog + LN_TPE + BalanceToTerm + InterestRate_Margin + 
                                     ...
                                     # M_Repo_Rate + M_Repo_Rate_10 + M_Inflation_Growth + M_DTI_Growth + 
                                     # M_DTI_Growth_11 + M_Emp_Growth + M_RealIncome_Growth
                                     # AgeToTerm + M_Repo_Rate_3 + M_Repo_Rate_4 + M_Repo_Rate_6 + M_Inflation_Growth_1 + M_Inflation_Growth_10 + 
                                     # M_Inflation_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 + 
                                     # M_Emp_Growth_12 + M_RealIncome_Growth_8 + M_RealIncome_Growth_9 + M_RealIncome_Growth_11 + 
                                     # M_RealIncome_Growth_12 + M_RealGDP_Growth_12 + M_RealGDP_Growth_11 + M_RealGDP_Growth_4 + M_Repo_Rate_8 + 
                                     # M_RealGDP_Growth_1 + Age_Adj + M_Repo_Rate_2 + M_RealGDP_Growth
                                      
# logit_model_chosen <- glm(inputs_chosen, data=dat_SICR_def_train_s, family="binomial")
# summary(logit_model_chosen)

# - Compute the AUC
# dat_SICR_def_train_s[, Prob_chosen_1a_iii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
# dat_SICR_def_valid_s[, Prob_chosen_1a_iii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

# auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1a_iii) 
# auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1a_iii) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 86.34% | Iteration 2's AUC: 86.34% | Iteration 3's AUC: 86.34% | Iteration 4's AUC: 86.34% | Iteration 5's AUC: 86.34% |
# Iteration 6's AUC: 86.34% | Iteration 7's AUC: 86.34%

# NOTE: With the volatility variables - Report the AUC for the validation dataset
# Iteration 1's AUC: 86.34% | Iteration 2's AUC: 86.36% | Iteration 3's AUC: 86.36% | Iteration 4's AUC: 86.28% | Iteration 5's AUC: 86.26%
...
inputs_all_mc1 <- SICR_target_event ~ Term + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + 
                                      ...
                                      slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Repo_Rate_10 + 
                                      M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_11 + M_Emp_Growth + M_RealIncome_Growth
                                      # M_Repo_Rate_8 + M_RealGDP_Growth_1 + Age_Adj + M_Repo_Rate_2 + M_RealGDP_Growth
...
# Iteration 1: Age_Adj has VIF of 11.47, TimeInPerfSpell has VIF of 11.39, all the repo rates and real GDP growth rates have VIF > 10
# Remove Age_Adj, M_Repo_Rate_2 (nearest to the original) M_Repo_Rate_8 (least significant from all of the repo rate variables) and M_RealGDP_Growth_1 
# Iteration 2: M_Repo_Rate has a VIF > 10 but this is expected
...
table(datSICR$SICR_target) %>% prop.table() # 93.90% Non-SICR vs 6.10% SICR
...
# All variables are statistically significant apart from term and inflation growth, although inflation growth was purposefully included
# PD ratio is not statistically significant (p-value of 0.91643 and standard error of 0.00000000036191) as well as inflation growth and term
# But all other variables remain statistically significant

# - Score data using fitted model
datSICR_train[, Prob_chosen_1a_iii := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_1a_iii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_iii) # 86.54% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1a_iii) # 86.49% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 86.53% (before and after)
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_1a_iii)) + theme_bw() + 
...
datSICR_train[, Pred_chosen_1a_iii := ifelse(Prob_chosen_1a_iii >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_1a_iii := ifelse(Prob_chosen_1a_iii >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1a_iii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1a_iii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_1a_iii), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_1a_iii == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_1a_iii == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_1a_iii == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_1a_iii == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1151749
...
performance_measures_1a_iii <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                          d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_1a_iii); gc()
