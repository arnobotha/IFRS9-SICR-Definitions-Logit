...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=3, d=1, and s=1", x= "Time") + 
...
# Balance, FurtherLoan_Ind, FurtherLoan_Amt, and BalanceToTerm
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE + AgeToTerm
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_2) # 65.43%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_2) # 65.62%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.51%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 60.75%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 88.93%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 89.00%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 88.94%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 89.00%

# - Slightly higher AUC on the training dataset using the imputed variables. Look at the p-values again
summary(logit_model_delinq1)
summary(logit_model_delinq2)
# The theme with the imputed value have smaller p-values, indicating more significance
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 75.93% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 76.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 75.93% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 76.29%
...
# M_Repo_Rate, M_Repo_Rate_6, M_Repo_Rate_10, M_Repo_Rate_Vol_3, M_Repo_Rate_Vol_7, M_Repo_Rate_Vol_10 and M_Repo_Rate_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 59.35% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 59.35%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 59.20% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 59.21%
...
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 59.40%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 59.16% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 59.16%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 60.72% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.73%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 60.55% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 60.55%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 59.41% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 59.40%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 57.91% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 57.90%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 60.43% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 60.43%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 59.40% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 59.40%
...
# M_RealIncome_Growth_11, M_RealIncome_Growth_12, M_RealIncome_Growth_Vol_2 and M_RealIncome_Growth_Vol_10 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 60.21% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 60.21%
...
# M_RealIncome_Growth, M_RealIncome_Growth_1, M_RealIncome_Growth_2, M_RealIncome_Growth_3, M_RealIncome_Growth_8, M_RealIncome_Growth_9
# M_RealIncome_Growth_11 and M_RealIncome_Growth_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 58.38% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 58.38%

# The reduction in AUC is more significant than the previous variables, but the standard errors are big for the volatility variables

# Model with all the significant MVs
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_10 + M_Repo_Rate_12 + M_Inflation_Growth + M_Inflation_Growth_1 +
                                     M_Inflation_Growth_10 + M_DTI_Growth + M_DTI_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_8 +
                                     M_Emp_Growth_9 + M_Emp_Growth_11 + M_Emp_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_11 +
                                     M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_1 + M_RealIncome_Growth_2 +
                                     M_RealIncome_Growth_3 + M_RealIncome_Growth_8 + M_RealIncome_Growth_9 + M_RealIncome_Growth_11 +
                                     M_RealIncome_Growth_12


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
# inputs_chosen <- SICR_target_event ~ Age_Adj + Term + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin +
                                     ...
                                     # M_Repo_Rate + M_Repo_Rate_2 + M_Inflation_Growth + M_DTI_Growth  
                                     # LN_TPE + AgeToTerm + M_Repo_Rate_10 + M_Repo_Rate_12 + M_Inflation_Growth_10 + M_DTI_Growth_11 + 
                                     # M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 + M_Emp_Growth_12 + 
                                     # M_RealGDP_Growth + M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_1 + 
                                     # M_RealIncome_Growth_2 + M_RealIncome_Growth_3 + M_RealIncome_Growth_8 + M_RealIncome_Growth_9 + 
                                     # M_RealIncome_Growth_11 + M_RealIncome_Growth_12 + M_Inflation_Growth_1

# logit_model_chosen <- glm(inputs_chosen, data=dat_SICR_def_train_s, family="binomial")
# summary(logit_model_chosen)

# - Compute the AUC
# dat_SICR_def_train_s[, Prob_chosen_1a_i := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
# dat_SICR_def_valid_s[, Prob_chosen_1a_i := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

# auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1a_i) 
# auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1a_i) 

# Report the final AUC: 91.61%

# Report the AUC for the validation dataset
# Iteration 1's AUC: 91.63% | Iteration 2's AUC: 91.62% | Iteration 3's AUC: 91.62%
# NOTE: PrevDefault has a high p-value but keeping it in for judgemental purposes and the "Suspense" payment method also has a high p-value

# Report the AUC for the validation dataset (NOTE: THIS WAS INCLUDING THE VOLATILITY VARIABLES PREVIOUSLY)
# Iteration 1's AUC: 91.58% | Iteration 2's AUC: 91.58% | Iteration 3's AUC: 91.56% | Iteration 4's AUC: 91.56%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Age_Adj + Term + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin +
                  TimeInPerfSpell + PerfSpell_Num + g0_Delinq + PrevDefaults + slc_acct_roll_ever_24_imputed +
                  slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Repo_Rate_2 + M_Inflation_Growth + M_DTI_Growth 
...
table(datSICR$SICR_target) %>% prop.table() # 93.81% Non-SICR vs 6.19% SICR
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1a_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1a_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_1a_i); gc()
