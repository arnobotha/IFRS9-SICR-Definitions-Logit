# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2b(iv) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=12, d=2, and s=2", x= "Time") + 
...
inputs_account4 <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + LN_TPE + BalanceToTerm + InterestRate_Margin
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 61.05%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 59.27%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 64.81%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 63.16%
...
# TimeInPerfSpell, PerfSpell_Num and PrevDefaults are insignificant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 81.74%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 81.09%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 81.74%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 81.09%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 72.78% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 72.87%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 72.78% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 72.87%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 58.75% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 57.99%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.05% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 57.13%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 59.07% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 58.54%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 58.88% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 58.41%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 61.10% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.90%
...
# M_DTI_Growth_12 is the most significant (20.30% p-value)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 61.05% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 60.90%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 60.65% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 60.54%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 59.89% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 59.62%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 61.05% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 60.79%
...
# M_RealGDP_Growth_12 is the most significant (p-value of 10.60%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 60.57% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 60.38%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 61.18% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 60.71%
...
# None are significant, but M_RealIncome_Growth_12 is the most significant (p-value of 24.20%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 60.16% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 59.67%

# The reduction in AUC is more significant than the previous variables, but the standard errors are big for the volatility variables

# Model with all the significant MVs
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealGDP_Growth + 
...
inputs_chosen <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + TimeInPerfSpell + 
                                     g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + slc_acct_pre_lim_perc_imputed +
                                     M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealGDP_Growth + 
                                     M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12
                                     # LN_TPE + PerfSpell_Num + PrevDefaults
...
# Age_Adj, Receipt_InfLog, BalanceLog, InterestRate_Margin, g0_Delinq, BalanceToTerm (somewhat with a p-value of 25.05%), TimeInPerfSpell (somewhat with a p-value of 27.26%),
# slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed, slc_pmnt_method, slc_acct_pre_lim_perc_imputed
# Remove the insignificant variables that are not MVs before running iteration 2
# Iteration 2
# Repo rate and inflation growth rate are insignificant (p-values of 96.52% and 50.42% respectively)
# DTI growth rate is significant and its 12-month lag is also quite significant (p-value of 16.55%)
# Employment growth and its 12-month lag are rather significant (p-values of around 20%)
# The 12-month real GDP growth is quite significant with a p-value of 13.88% but its 0-month lag is insignificant (p-value of 64.47%)
# Real income growth and its 12-month lag are significant

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2b_iv := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2b_iv := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2b_iv) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2b_iv) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 86.58% | Iteration 2's AUC: 86.57%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + BalanceToTerm + InterestRate_Margin + TimeInPerfSpell + 
                                      g0_Delinq + slc_acct_roll_ever_24_imputed + slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + 
                                      M_DTI_Growth + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_12 + M_RealGDP_Growth + 
                                      M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12
...
datSICR_valid[, Prob_chosen_2b_iv := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2b_iv) # 85.77%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2b_iv) # 84.11%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 85.11%
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_2b_iv)) + theme_bw() + 
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2b_iv", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
datSICR_train[, Pred_chosen_2b_iv := ifelse(Prob_chosen_2b_iv >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_2b_iv := ifelse(Prob_chosen_2b_iv >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2b_iv, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2b_iv, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_2b_iv), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_2b_iv == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_2b_iv == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_2b_iv == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_2b_iv == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.0968483

# A few things of concern:
# 1) Volatility in event rates due to relatively low sampling volumes in validation set
# 2) 0-counts over 20006-2007 periods using discretised output [Pred_chosen_2b_iv]
...
performance_measures_2b_iv <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                         d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_2b_iv); gc()
