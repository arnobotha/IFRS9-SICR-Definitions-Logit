# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2c(i) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
summary(logit_model_chosen)
# Not all variables are statistically significant before including PD-ratio
# PD-ratio is not statistically significant with a p-value of 0.63236 and standard error of 0.05230
