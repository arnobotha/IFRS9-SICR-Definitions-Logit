# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 1c(iv) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=12, d=1, and s=3", x= "Time") + 
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + FurtherLoan_Ind + FurtherLoan_Amt + LN_TPE + AgeToTerm
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.84%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 60.70%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 64.70%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 64.65%
...
# All the variables are significant enough
...
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 84.73%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 84.80%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 84.70%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 74.60% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 74.74%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 74.60% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 74.74%

# - The AUC-values are the same. Look at the p-values and standard errors
summary(logit_model_behav3)
summary(logit_model_behav4)
# p-values and standard errors are equal
# Conclusion: Use the imputed variables to be consistent with the choice from the delinquency theme
...
# M_Repo_Rate, M_Repo_Rate_2, M_Repo_Rate_4, M_Repo_Rate_6, M_Repo_Rate_8, M_Repo_Rate_10, M_Repo_Rate_11,
# M_Repo_Rate_Vol_3, M_Repo_Rate_Vol_7, M_Repo_Rate_Vol_9, M_Repo_Rate_Vol_10 and M_Repo_Rate_Vol_12 are significant
...
# M_Repo_Rate, M_Repo_Rate_2, M_Repo_Rate_3, M_Repo_Rate_4, M_Repo_Rate_6, M_Repo_Rate_8, M_Repo_Rate_10 and M_Repo_Rate_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 60.59% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 60.60%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 59.01% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 59.02%
...
# M_Inflation_Growth, M_Inflation_Growth_1, M_Inflation_Growth_3, M_Inflation_Growth_7, M_Inflation_Growth_10, M_Inflation_Growth_11, M_Inflation_Growth_12, 
...
# M_Inflation_Growth, M_Inflation_Growth_1, M_Inflation_Growth_10, M_Inflation_Growth_11 and M_Inflation_Growth_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 59.13% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 59.12%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 58.67% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 58.65%
...
# M_DTI_Growth_12 and M_DTI_Growth_Vol_2 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 62.26% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 62.25%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 61.85% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 61.84%
...
# M_Emp_Growth, M_Emp_Growth_1, M_Emp_Growth_8, M_Emp_Growth_11 and M_Emp_Growth_12 are significant
...
# No volatility-related variables are significant
...
# M_RealIncome_Growth, M_RealIncome_Growth_1, M_RealIncome_Growth_12, M_RealIncome_Growth_Vol_2, M_RealIncome_Growth_Vol_10,
...
inputs_macro <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_3 + M_Repo_Rate_4 + M_Repo_Rate_6 + M_Repo_Rate_8 + M_Repo_Rate_10 + M_Repo_Rate_12 +
                                    M_Inflation_Growth + M_Inflation_Growth_1 + M_Inflation_Growth_10 + M_Inflation_Growth_11 + M_Inflation_Growth_12 + 
                                    M_DTI_Growth + M_DTI_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_1 + M_Emp_Growth_11 + M_Emp_Growth_12 +
                                    M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth +
...
inputs_chosen <- SICR_target_event ~ Term + BalanceLog + LN_TPE + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + 
                                     slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + slc_acct_pre_lim_perc_imputed +
                                     M_Repo_Rate + M_Repo_Rate_10 + M_Inflation_Growth + M_Inflation_Growth_10 + 
                                     M_DTI_Growth + M_DTI_Growth_11 + M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealIncome_Growth
                                     # Receipt_InfLog + AgeToTerm + BalanceToTerm + M_Repo_Rate_3 + M_Repo_Rate_4 + M_Repo_Rate_6 + M_Repo_Rate_8 + M_Repo_Rate_12 +
                                     # M_Inflation_Growth_11 + M_Inflation_Growth_12 + M_DTI_Growth_12 + M_Emp_Growth_1 + M_RealIncome_Growth_11 + M_RealIncome_Growth_12
                                     # M_Inflation_Growth_1
...
# Term, BalanceLog, LN_TPE, InterestRate_Margin, TimeInPerfSpell, PerfSpell_Num, g0_Delinq, slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed, slc_pmnt_method,
# slc_acct_pre_lim_perc_imputed, M_Repo_Rate, M_Repo_Rate_2, M_DTI_Growth + M_DTI_Growth_11, M_Emp_Growth_11, M_Emp_Growth_12, M_RealGDP_Growth_11,
# M_RealIncome_Growth_11
# The following variable have p-values greater than 5% but less than 20%:
# PrevDefaults, M_Repo_Rate_10, M_Inflation_Growth_1, M_Inflation_Growth_10, M_RealGDP_Growth, M_RealGDP_Growth_1, M_RealGDP_Growth_12
# Iteration 2
...
# Iteration 3
# The following variables are not significant in no particular order:
# PrevDefaults, M_Emp_Growth_12, M_RealGDP_Growth_11, M_RealGDP_Growth_12
# Iteration 4
# The following variables are not significant in no particular order:
# M_Emp_Growth, M_Emp_Growth_11
# Iteration 5
# All the variables are significant, but remove so that there are two left for the MVs (remove the least significant one)
# M_Repo_Rate_2

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_1c_iv := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_1c_iv := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1c_iv) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1c_iv) 

# Iteration 1's AUC: 87.12% | Iteration 2's AUC: 87.12% | Iteration 3's AUC: 87.11% | Iteration 4's AUC: 87.10% | Iteration 5's AUC: 87.10%

# - Analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Term + BalanceLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + slc_acct_roll_ever_24_imputed + 
                                      slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Repo_Rate_10 + M_Inflation_Growth + M_Inflation_Growth_10 + 
                                      M_DTI_Growth + M_DTI_Growth_11 + M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealIncome_Growth
...
table(datSICR$SICR_target) %>% prop.table() # 96.24% Non-SICR vs 3.76% SICR
...
summary(logit_model_chosen)
# Most variables are statistically significant, except: Term, TimeInPerfSpell, M_Inflation_Growth,
#     pmnt_method_grp (but only its "Salary/Suspense" bin)
# [Ad hoc] PD ratio is not statistically significant (p-value of 0.370771 and standard error of 0.0009790)

# - Score data using fitted model
datSICR_train[, Prob_chosen_1c_iv := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_1c_iv := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1c_iv) # 87.10% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1c_iv) # 86.72% vs 86.67%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 86.98% vs 86.97%
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_1c_iv)) + theme_bw() + 
...
datSICR_train[, Pred_chosen_1c_iv := ifelse(Prob_chosen_1c_iv >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_1c_iv := ifelse(Prob_chosen_1c_iv >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1c_iv, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1c_iv, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_1c_iv), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_iv == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_iv == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_iv == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_iv == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.08562917 
...
(g <- ggplot(port.aggr, aes(x=Date, y=EventRate, group=Type)) + theme_minimal() + 
    ...
    annotate(geom="text", x=as.Date("2015-12-31"), y=port.aggr[Date >= "2012-12-31" & Type=="a_Actual", mean(EventRate)]*2.9,
...
performance_measures_1c_iv <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                         d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_1c_iv); gc()
