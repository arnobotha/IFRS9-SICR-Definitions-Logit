# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 1c(i) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=3, d=1, and s=3", x= "Time") + 
...
inputs_account3 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + 
                                       FurtherLoan_Ind + FurtherLoan_Amt + LN_TPE + BalanceToTerm

logit_model_account3 <- glm(inputs_account3, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_account3)
# FurtherLoan_Ind and FurtherLoan_Amt are not significant

inputs_account4 <- SICR_target_event ~ Age_Adj + Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE + BalanceToTerm
...
inputs_account5 <- SICR_target_event ~ Age_Adj + Term + Receipt_InfLog + BalanceLog + LN_TPE + BalanceToTerm + InterestRate_Margin

logit_model_account5 <- glm(inputs_account5, data=dat_SICR_def_train_s, family="binomial")
summary(logit_model_account5)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 62.76%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 62.71%

dat_SICR_def_train_s[, Prob_account_5 := predict(logit_model_account5, newdata = dat_SICR_def_train_s, type="response")]
dat_SICR_def_valid_s[, Prob_account_5 := predict(logit_model_account5, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_5) # 67.98%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_5) # 68.02%
...
# PerfSpell_Num is insignificant; however, given its significance in the other definitions, keep
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 94.92%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 94.83%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 94.91%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 94.83%

# Conclusion: Keep the imputed variables to be consistent with the previous definitions
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 77.31% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 76.99%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 77.31% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 76.99%

# Conclusion: Use the imputed variables to be consistent with the previous definitions
...
# M_Repo_Rate, M_Repo_Rate_10, M_Repo_Rate_12, M_Repo_Rate_Vol_3 and M_Repo_Rate_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 61.12% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 61.16%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 61.05% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 61.09%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 61.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 61.37%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 60.81% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 60.84%
...
# M_DTI_Growth_11, M_DTI_Growth_12, M_DTI_Growth_Vol_2 and M_DTI_Growth_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 62.71% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 62.75%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 62.60% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 62.64%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 61.03% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 61.06%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 59.54% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 59.56%
...
# M_RealGDP_Growth_12 and M_RealGDP_Growth_Vol_2 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 62.46% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 62.50%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 61.00% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 61.03%
...
# M_RealIncome_Growth_12, M_RealIncome_Growth_Vol_2 and M_RealIncome_Growth_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 62.36% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 62.39%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 60.26% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 60.27%

# The reduction in AUC is more significant than the previous variables, but the standard errors are big for the volatility variables

# Model with all the significant MVs
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_10 + M_Repo_Rate_12 + M_Inflation_Growth +
                                     M_Inflation_Growth_1 + M_DTI_Growth + M_DTI_Growth_8 + M_DTI_Growth_9 + M_DTI_Growth_11 +
                                     M_DTI_Growth_12 + M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 +
                                     M_Emp_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_11 + M_RealGDP_Growth_12 +
                                     M_RealIncome_Growth + M_RealIncome_Growth_1 + M_RealIncome_Growth_3 + M_RealIncome_Growth_9 +
...
inputs_chosen <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + InterestRate_Margin +
                                     TimeInPerfSpell + PerfSpell_Num + g0_Delinq + PrevDefaults + slc_acct_arr_dir_3 + 
                                     slc_acct_roll_ever_24_imputed + slc_pmnt_method + slc_acct_pre_lim_perc_imputed +
                                     M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_RealGDP_Growth
                                     # Term + LN_TPE + BalanceToTerm + M_Repo_Rate_2 + M_Repo_Rate_10 + M_Repo_Rate_12 +
                                     # M_DTI_Growth_8 + M_DTI_Growth_9 + M_DTI_Growth_11 + M_DTI_Growth_12 + M_Emp_Growth + 
                                     # M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 + M_Emp_Growth_12 + M_Inflation_Growth_1 +
                                     # M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_1 + 
                                     # M_RealIncome_Growth_3 + M_RealIncome_Growth_11 + M_RealIncome_Growth_12 + M_RealIncome_Growth_9
...
# Age_Adj, Receipt_InfLog, BalanceLog, InterestRate_Margin, TimeInPerfSpell, g0_Delinq, PrevDefaults, slc_acct_arr_dir_3, slc_pmnt_method
# slc_acct_pre_lim_perc_imputed, slc_acct_roll_ever_24_imputed, M_Repo_Rate, M_DTI_Growth, M_RealGDP_Growth
# The following variables have p-values greater than 5% but smaller than 20%:
# M_RealIncome_Growth_9, M_RealIncome_Growth_11, M_RealIncome_Growth_12
# Iteration 2
# The following variables are not significant in no particular order:
# M_RealIncome_Growth_11, M_RealIncome_Growth_12
# The following variables have p-values greater than 5% but smaller than 20%:
# Age_Adj, M_RealIncome_Growth_9
# Iteration 3
# The following variables are not significant in no particular order:
...
# Age_Adj
# Iteration 4
# PerfSpell_Num and M_Inflation_Growth is not significant, but kept for consistency with the other variables

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_1c_i := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_1c_i := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1c_i) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1c_i) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 95.55% | Iteration 2's AUC: 95.54% | Iteration 3's AUC: 95.54% | Iteration 4's AUC: 95.54%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + InterestRate_Margin +
...
table(datSICR$SICR_target) %>% prop.table() # 96.15% Non-SICR vs 3.85% SICR
...
datSICR_valid[, Prob_chosen_1c_i := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1c_i) # 95.58%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1c_i) # 95.73%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 95.62%
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_1c_i)) + theme_bw() + 
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_1c_i", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
datSICR_train[, Pred_chosen_1c_i := ifelse(Prob_chosen_1c_i >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_1c_i := ifelse(Prob_chosen_1c_i >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1c_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1c_i, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_1c_i), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_i == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_i == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_i == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_i == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.06778837
...
(g <- ggplot(port.aggr, aes(x=Date, y=EventRate, group=Type)) + theme_minimal() + 
    ...
    #annotations
    annotate(geom="text", x=as.Date("2015-12-31"), y=port.aggr[Date >= "2012-12-31" & Type=="a_Actual", mean(EventRate)]*3.7,
             label=paste0("'MAE between '*italic(A[t])*' and '*italic(B[t])*': ", sprintf("%.2f", diag.Act_ExpProb),"%'"),
             family=chosenFont, size=3, parse=T) + 
    annotate(geom="text", x=as.Date("2015-12-31"), y=port.aggr[Date >= "2012-12-31" & Type=="a_Actual", mean(EventRate)]*3.3,
...
performance_measures_1c_i <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                        d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_1c_i); gc()
