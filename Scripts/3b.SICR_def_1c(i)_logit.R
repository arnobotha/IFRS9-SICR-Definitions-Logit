...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1c_i) # 95.58% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1c_i) # 95.73% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 95.62% (before and after)
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.09675761
