...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_iv) # 84.95% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1a_iv) # 84.82% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 84.91% (before and after)
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1163142
