# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 1c(iii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=9, d=1, and s=3", x= "Time") + 
...
inputs_account4 <- SICR_target_event ~ Term + Receipt_InfLog + BalanceLog + LN_TPE + AgeToTerm + BalanceToTerm + InterestRate_Margin
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 61.12%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 60.84%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 65.33%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 64.75%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 86.54%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 86.25%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 86.51%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 86.22%

# - The variables are more significant for the imputed variables - keep
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 75.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 75.18%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 75.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 75.18%

# - The AUC-values are the same. Look at the p-values and standard errors
summary(logit_model_behav3)
summary(logit_model_behav4)
# p-values and standard errors are equal
# use the value imputed variables to be consistent with the choice from the delinquency theme
...
# M_Repo_Rate, M_Repo_Rate_3, M_Repo_Rate_4, M_Repo_Rate_6, M_Repo_Rate_8, M_Repo_Rate_9, M_Repo_Rate_10, M_Repo_Rate_11, 
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 60.84% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 60.83%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 59.89% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 59.89%

# Just a little less than a 1% reduction
...
# M_Inflation_Growth_Vol_2, M_Inflation_Growth_Vol_5 and M_Inflation_Growth_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 60.18% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 60.19%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 59.80% 
...
# M_DTI_Growth, M_DTI_Growth_12 and M_DTI_Growth_Vol_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 62.56% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 62.56%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 62.26% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 62.27%
...
# M_RealIncome_Growth, M_RealIncome_Growth_1, M_RealIncome_Growth_4, M_RealIncome_Growth_11, M_RealIncome_Growth_12, 
...
# M_RealIncome_Growth, M_RealIncome_Growth_9, M_RealIncome_Growth_11 and M_RealIncome_Growth_12 are significant
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 61.79% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 61.79%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 60.53% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 60.53%

# Little more than a 1% reduction

# Model with all the significant MVs
inputs_macro <- SICR_target_event ~ M_Repo_Rate + M_Repo_Rate_2 + M_Repo_Rate_3 + M_Repo_Rate_4 + M_Repo_Rate_6 +
                                    M_Repo_Rate_8 + M_Repo_Rate_10 + M_Inflation_Growth + M_Inflation_Growth_1 +
                                    M_Inflation_Growth_10 + M_DTI_Growth + M_DTI_Growth_11 + M_DTI_Growth_12 +
                                    M_Emp_Growth + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_11 + M_Emp_Growth_12 +
                                    M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealGDP_Growth_11 + M_RealGDP_Growth_12 +
                                    M_RealIncome_Growth + M_RealIncome_Growth_9 + M_RealIncome_Growth_11 + M_RealIncome_Growth_12


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
inputs_chosen <- SICR_target_event ~ Term + BalanceLog + LN_TPE + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + 
                                     ...
                                     M_Inflation_Growth_10 + M_DTI_Growth + M_DTI_Growth_11 + M_RealGDP_Growth + 
                                     M_RealGDP_Growth_1 + M_RealIncome_Growth 
                                     # Receipt_InfLog + AgeToTerm + BalanceToTerm + PrevDefaults + M_Inflation_Growth_1 +
                                     # M_DTI_Growth_12 + M_Emp_Growth_8 + M_Emp_Growth_9 + M_Emp_Growth_12
                                     # M_RealGDP_Growth_11 + M_RealGDP_Growth_12 + M_RealIncome_Growth_9 + 
                                     # M_RealIncome_Growth_11 + M_RealIncome_Growth_12 + M_Repo_Rate_4 + M_Repo_Rate_6 +
                                     # M_Emp_Growth + M_Emp_Growth_11 + M_Repo_Rate_3 + M_Repo_Rate_8 + M_Repo_Rate_10
...
# Term, BalanceLog, LN_TPE, InterestRate_Margin, TimeInPerfSpell, PerfSpell_Num, g0_Delinq, slc_acct_arr_dir_3,
# slc_acct_roll_ever_24_imputed, slc_pmnt_method, slc_acct_pre_lim_perc_imputed, M_Repo_Rate, M_Repo_Rate_2, M_Repo_Rate_3,
# M_Repo_Rate_8, M_Inflation_Growth_10, M_DTI_Growth, M_RealGDP_Growth, M_RealIncome_Growth
# The following variables have p-values greater than 5% but less than 20%:
# M_Repo_Rate_10, M_Inflation_Growth, M_DTI_Growth_11, M_Emp_Growth, M_Emp_Growth_11, M_RealGDP_Growth_1
# Iteration 2
# The following variables are not significant in no particular order:
# M_Repo_Rate_4, M_Repo_Rate_6, M_Emp_Growth, M_Emp_Growth_11
# Iteration 3
# Keep the unlagged and 2-month repo rate lag
# Iteration 4
# All the variables are significant

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_1c_iii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_1c_iii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_1c_iii) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_1c_iii) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 88.64% | Iteration 2's AUC: 88.64% | Iteration 3's AUC: 88.64% | Iteration 4's AUC: 88.64% 

# - Analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ Term + BalanceLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + 
                                      g0_Delinq + slc_acct_roll_ever_24_imputed + slc_acct_pre_lim_perc_imputed + 
                                      M_Repo_Rate + M_Repo_Rate_2 + M_Inflation_Growth + M_Inflation_Growth_10 + 
                                      M_DTI_Growth + M_DTI_Growth_11 + M_RealGDP_Growth + M_RealGDP_Growth_1 + M_RealIncome_Growth 
...
table(datSICR$SICR_target) %>% prop.table() # 96.19% Non-SICR vs 3.81% SICR
...
# PD ratio is not statistically significant (p-value of 0.861255 and standard error of 0.00015702)

# The following variables are insignificant:
# TimeInPerfSpell (p-value of 27.03%) and PerfSpell_Num (p-value of 10.24%), as well as inflation growth (p-value of 27.92%)

# - Score data using fitted model
datSICR_train[, Prob_chosen_1c_iii := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_1c_iii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1c_iii) # 89.17% (before and after)
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_1c_iii) # 88.89% (before and after)
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 89.08% (before and after)
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_1c_iii)) + theme_bw() + 
...
datSICR_train[, Pred_chosen_1c_iii := ifelse(Prob_chosen_1c_iii >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_1c_iii := ifelse(Prob_chosen_1c_iii >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1c_iii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1c_iii, data=datSICR_valid, ci.method="bootstrap", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_1c_iii), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_iii == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_1c_iii == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_iii == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_1c_iii == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.1082446
...
performance_measures_1c_iii <- data.frame(SICR_definition = paste0(SICR_label, "_logit"),
                                          d=p.d, s=p.s, k=p.k,
...
pack.ffdf(paste0(genPath, "performance_measures_", SICR_label), performance_measures_1c_iii); gc()
