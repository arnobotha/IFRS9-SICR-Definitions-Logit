# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2c(iv) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=12, d=2, and s=3", x= "Time") + 
...
# Age_Adj, Term and FurtherLoan_Amt
...
inputs_account3 <- SICR_target_event ~ Receipt_Inf + Balance + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE + AgeToTerm + BalanceToTerm
...
inputs_account4 <- SICR_target_event ~ Age_Adj + Receipt_InfLog + BalanceLog + LN_TPE + AgeToTerm + BalanceToTerm + InterestRate_Margin
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 61.46%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 61.57%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 63.51%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 66.85%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 86.22%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 83.38%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 81.97%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 73.03% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 70.94%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 73.03% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 70.94%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 59.34% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 60.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.81% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 59.69%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 60.07% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 62.18%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 59.99% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 62.22%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 61.26% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 64.03%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 61.39% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 64.32%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 60.98% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 64.69%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 60.52% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 63.58%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 61.13% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 64.91%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 60.70% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 64.33%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 61.88% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 65.26%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 61.16% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 63.97%
...
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_Emp_Growth + M_Emp_Growth_12 


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
inputs_chosen <- SICR_target_event ~  BalanceLog + BalanceToTerm + InterestRate_Margin + g0_Delinq + 
                                      slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + 
                                      slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_Emp_Growth
                                      # Age_Adj, Receipt_InfLog, LN_TPE, AgeToTerm, TimeInPerfSpell, PerfSpell_Num,
                                      # PrevDefaults, M_Emp_Growth_12
...
# Age_Adj, Receipt_InfLog, LN_TPE, AgeToTerm, TimeInPerfSpell, PerfSpell_Num
# Will remove the insignificant variables from the second iteration
# Iteration 2
# The following variables are insignificant:
# PrevDefaults, repo rate and the 12-month employment growth rate

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2c_iv := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2c_iv := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2c_iv) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2c_iv) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 87.42% | Iteration 2's AUC: 87.57% | Iteration 3's AUC: 87.56%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ BalanceLog + BalanceToTerm + InterestRate_Margin + g0_Delinq + slc_acct_roll_ever_24_imputed + 
                                      slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_Emp_Growth
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2c_iv, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2c_iv, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_2c_iv); gc()
