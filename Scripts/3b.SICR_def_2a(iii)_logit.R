...
summary(logit_model_chosen)
# Most variables are statistically significant, except: BalanceLog, pmnt_method_grp (but only its "MISSING" and Salary/Suspense" bins),
#     TimeInPerfSpell, slc_acct_arr_dir_3 (but only its "MISSING" bin), M_Repo_Rate, M_Inflation_Growth
...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$ExpProb) # 85.66% vs 85.67%
auc(datSICR_valid$SICR_target, datSICR_valid$ExpProb) # 84.61% vs 84.63%
