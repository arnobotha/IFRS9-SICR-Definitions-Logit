...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2b_iii) # 87.69%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2b_iii) # 90.30%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 88.72%
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2b_iii", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.8790727
