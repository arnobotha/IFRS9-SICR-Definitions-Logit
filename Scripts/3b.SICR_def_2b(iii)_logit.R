# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2b(iii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=9, d=2, and s=2", x= "Time") + 
...
# Age_Adj, Balance, FurtherLoan_Ind, FurtherLoan_Amt, AgeToTerm + BalanceToTerm
...
# Age_Adj and AgeToTerm

# - Remove the insignificant variables from the "raw" variable theme and analyse again
inputs_account3 <- SICR_target_event ~ Term + Receipt_Inf + Redraw_Ind + Redrawn_Amt + InterestRate_Margin + LN_TPE
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.52%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 59.79%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 65.18%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 65.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 85.95%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 84.84%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 85.92%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 84.84%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 73.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 71.17%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 73.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 71.17%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 58.87% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 58.25%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 58.35% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 57.86%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 59.72% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 59.35%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_4) # 59.68% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 59.41%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 61.18% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 60.63%
...
# M_DTI_Growth_12 is the most significant (28.500% p-value)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 61.24% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 60.74%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 60.28% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 60.00%
...
# M_Emp_Growth_12 is the most significant (p-value of 9.95%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 59.67% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 59.29%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 61.08% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 60.66%
...
# M_RealGDP_Growth_12 is the most significant (p-value of 17.10%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 60.34% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 60.05%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 61.32% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 61.05%
...
# M_RealIncome_Growth_12 is the most significant (p-value of 8.35%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 60.28% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 59.88%
...
inputs_chosen <- SICR_target_event ~ BalanceLog + InterestRate_Margin + g0_Delinq + slc_acct_arr_dir_3 + slc_acct_roll_ever_24_imputed + slc_pmnt_method + 
                                     slc_acct_pre_lim_perc_imputed + M_Repo_Rate + M_Inflation_Growth + M_DTI_Growth + M_RealIncome_Growth + 
                                     M_RealIncome_Growth_12 + M_RealGDP_Growth + M_RealGDP_Growth_12
                                     # Receipt_InfLog, LN_TPE, BalanceToTerm, TimeInPerfSpell, PrevDefaults, M_DTI_Growth_12, M_Emp_Growth, M_Emp_Growth_12 
...
# BalanceLog, InterestRate_Margin, g0_Delinq, slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed + slc_pmnt_method + slc_acct_pre_lim_perc_imputed
# Remove the insignificant variables first and then look at the MVs
# Iteration 2
# Repo and inflation growth rate is insignificant, DTI growth is somewhat significant (p-value of 10.90%), M_RealIncome_Growth_12 is significant as well as
# M_RealGDP_Growth_12
# Iteration 3
# Repo rate is now more significant (p-value of 17.19%) but inflation growth rate is not
# Did not remove any new variables

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2b_iii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2b_iii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2b_iii) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2b_iii) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 86.70% | Iteration 2's AUC: 86.68%
...
# Not all variables are statistically significant, including: Balance to term, receipt, payment method, time in performing spell,
# repo rate, inflation growth rate and the 12-month lagged DTI growth rate
# After including PD ratio, the statistically insignificant variables are: Balance to term, receipt, payment method, time in performing spell,
# repo rate, inflation growth rate and the 12-month lagged DTI growth rate
# Therefore, the inclusion of PD ratio did not change the significance of any variables
# [Ad hoc] PD ratio is not statistically significant (p-value of 0.899381 and a standard error of 0.000026964)
...
datSICR_train[, Prob_chosen_2b_iii := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_2b_iii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2b_iii) # 87.69% vs 87.68%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2b_iii) # 90.30% vs 90.29%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 88.72% (before and after)
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_2b_iii)) + theme_bw() + 
...
datSICR_train[, Pred_chosen_2b_iii := ifelse(Prob_chosen_2b_iii >= logistic_cutoff, 1, 0)]
datSICR_valid[, Pred_chosen_2b_iii := ifelse(Prob_chosen_2b_iii >= logistic_cutoff, 1, 0)]
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2b_iii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2b_iii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
datSICR_valid[, SICR_predict_variance := sd(Prob_chosen_2b_iii), by=list(LoanID)]
standard_deviation <- round(mean(datSICR_valid$SICR_predict_variance, na.rm=T)*100, digits=1)

# - Confusion matrix
conf_mat <- datSICR_valid[, list(TN=sum(ifelse(SICR_target == 0 & Pred_chosen_2b_iii == 0, 1, 0)),
                                 FP=sum(ifelse(SICR_target == 0 & Pred_chosen_2b_iii == 1, 1, 0)),
                                 TP=sum(ifelse(SICR_target == 1 & Pred_chosen_2b_iii == 1, 1, 0)),
                                 FN=sum(ifelse(SICR_target == 1 & Pred_chosen_2b_iii == 0, 1, 0)))]
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.4080724

# A few things of concern:
# 1) Volatility in event rates due to relatively low sampling volumes in validation set
# 2) 0-counts over 20006-2007 periods using discretised output [Pred_chosen_2b_iii]
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_2b_iii); gc()
