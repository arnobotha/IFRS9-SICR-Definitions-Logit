# ============================== SICR-MODELLIING ===============================
# SICR-model for definition 2c(iii) using Logistic Regression (LR)
# ------------------------------------------------------------------------------
...
ggplot(plot.data_SICR_rates, aes(x=Date, y=Proportion, colour=Prop)) + 
  ...
  labs(y="SICR-incidence rates for definition with parameters k=9, d=2, and s=3", x= "Time") + 
...
# Term, Receipt_Inf, InterestRate_Margin
...
# The variables that are significant are:
# Receipt_InfLog, BalanceLog, BalanceToTerm, InterestRate_Margin

# - Remove the insignificant variables from the "raw" variable theme and analyse again
inputs_account3 <- SICR_target_event ~ Term + Receipt_Inf + InterestRate_Margin
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_3) # 60.13%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_3) # 57.01%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_account_4) # 65.38%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_account_4) # 63.27%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_1) # 88.59%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_1) # 86.57%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_delinq_2) # 88.57%
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_delinq_2) # 86.59%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_3) # 73.45% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_3) # 73.32%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_behav_4) # 73.45% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_behav_4) # 73.32%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_1) # 59.67% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_1) # 60.53%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_2) # 59.38% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_2) # 60.39%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_3) # 60.54% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_3) # 63.08%
...
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_4) # 63.03%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_5) # 61.29% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_5) # 63.60%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_6) # 61.41% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_6) # 64.01%

# No reduction in the AUC, in fact, the AUC increased
...
# M_Emp_Growth_12 is the most significant (p-value of 18%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_7) # 60.59% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_7) # 63.75%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_8) # 60.40% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_8) # 63.34%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_9) # 61.33% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_9) # 64.57%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_10) # 60.69% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_10) # 63.94%
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_11) # 62.08% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_11) # 64.81%
...
# M_RealIncome_Growth_12 is the most significant (p-value of 18.80%)
...
auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_macro_12) # 61.43% 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_macro_12) # 64.15%

# The reduction in AUC is not significant, but the standard errors are big for the volatility variables

# Model with all the significant MVs
inputs_macro7 <- SICR_target_event ~ M_Repo_Rate + M_Inflation_Growth + M_Emp_Growth + M_Emp_Growth_12 + M_RealIncome_Growth + M_RealIncome_Growth_12 


# --- 4.5 Combined information
# Analyse the all the significant variables from the modelling themes
inputs_chosen <- SICR_target_event ~  BalanceLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + slc_acct_arr_dir_3 + 
                                      ...
                                      # Receipt_InfLog, BalanceToTerm, PrevDefaults
...
# BalanceLog, InterestRate_Margin, TimeInPerfSpell, PerfSpell_Num, g0_Delinq, slc_acct_arr_dir_3, slc_acct_roll_ever_24_imputed, slc_pmnt_method,
# slc_acct_pre_lim_perc_imputed, M_Emp_Growth_12 and M_RealIncome_Growth_12
# Iteration 2
# Repo rate is not significant, inflation growth rate is rather significant
# The other MVs' 12-month lags are significant

# - Compute the AUC
dat_SICR_def_train_s[, Prob_chosen_2c_iii := predict(logit_model_chosen, newdata = dat_SICR_def_train_s, type="response")] 
dat_SICR_def_valid_s[, Prob_chosen_2c_iii := predict(logit_model_chosen, newdata = dat_SICR_def_valid_s, type="response")]

auc(dat_SICR_def_train_s$SICR_target_event, dat_SICR_def_train_s$Prob_chosen_2c_iii) 
auc(dat_SICR_def_valid_s$SICR_target_event, dat_SICR_def_valid_s$Prob_chosen_2c_iii) 

# Report the AUC for the validation dataset
# Iteration 1's AUC: 89.28% | Iteration 2's AUC: 89.32%

# - Include only the numerical variables to analyse possible multicollinearity
inputs_all_mc1 <- SICR_target_event ~ BalanceLog + InterestRate_Margin + TimeInPerfSpell + PerfSpell_Num + g0_Delinq + 
...
# Not all variables are statistically significant, including: Interest rate margin, balance, payment method, prepaid funds, missing group
# of account arrears direction, if the account rolled ever in the last 24 months, real income growth, inflation growth,
# employment growth and its 12-month lag, and the 12-month lagged real income growth
# After including PD ratio, the statistically insignificant variables are: Interest rate margin, balance, payment method, prepaid funds, missing group
# of account arrears direction, if the account rolled ever in the last 24 months, real income growth, inflation growth,
# employment growth and its 12-month lag, and the 12-month lagged real income growth
# Therefore, the inclusion of PD ratio did not change the significance of any variables
# [Ad hoc] PD ratio is not statistically significant (p-value of 0.9853 and standard error of 0.000114714)
...
datSICR_train[, Prob_chosen_2c_iii := predict(logit_model_chosen, newdata = datSICR_train, type="response")] 
datSICR_valid[, Prob_chosen_2c_iii := predict(logit_model_chosen, newdata = datSICR_valid, type="response")]
datSICR_smp[, ExpProb := predict(logit_model_chosen, newdata = datSICR_smp, type="response")]

# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2c_iii) # 98.04%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2c_iii) # 74.70%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 80.97%
...
ggplot( data=datSICR_valid, aes(x=Prob_chosen_2c_iii)) + theme_bw() + 
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_2c_iii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_2c_iii, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
...
pack.ffdf(paste0(genObjPath, "performance_measures_", SICR_label), performance_measures_2c_iii); gc()
