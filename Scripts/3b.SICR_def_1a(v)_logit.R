...
# PD ratio is not statistically significant (p-value of 0.306533 and standard error of 0.0005369)
...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_1a_v) # 82.28% vs 82.46%
...
pROC_obj_chosena <- roc(formula= SICR_target~Pred_chosen_1a_v, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
pROC_obj_chosenb <- roc(formula= SICR_target~Prob_chosen_1a_v, data=datSICR_valid, ci.method="delong", ci=T, conf.level = 1-alpha, percent=T)
