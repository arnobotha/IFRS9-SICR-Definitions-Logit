...
# - Compute the AUC
auc(datSICR_train$SICR_target, datSICR_train$Prob_chosen_2a_i) # 91.92%
auc(datSICR_valid$SICR_target, datSICR_valid$Prob_chosen_2a_i) # 91.81%
auc(datSICR_smp$SICR_target, datSICR_smp$ExpProb) # 91.88%
...
optimal.cutpoint.GenYouden <- optimal.cutpoints(X = "Prob_chosen_2a_i", status = "SICR_target", tag.healthy = 0, # these are the negatives
...
if (!exists('logistic_cutoff')) logistic_cutoff <- 0.131065
